...
| **助教团队** | 赵子钰、张雨恬、许德成、童新荷、 李梓晟、张馨月、刘怿轩、王德宇、袁箐鸿                |
...
| 周次 | 日期  | 内容                                                  | 周次 | 日期  | 内容                                                   |
| ---- | ----- | ----------------------------------------------------- | ---- | ----- | ------------------------------------------------------ |
| 1    | 9.17  | 软件工程概述                                          | 9    | 11.12 | 行为驱动的开发                           |
| 2    | 9.24  | 单元测试 & Docker部署                                 | 10   | 11.19 | 软件系统建模（第一次检查）                                          |
| 3    | 10.1  | <span style="color:red;">**国庆放假**</span>              | 11   | 11.26 | 数据建模及数据库                              |
| 4    | 10.8  | 软件开发管理                                        | 12   | 12.3  | 设计模式 （第二次检查）                                |
| 5    | 10.15 | 需求获取                                        | 13   | 12.10 | 产品测试                                    |
| 6    | 10.22 | 交互设计与原型（学长分享）                                      | 14   | 12.17 | 系统部署与发布（第三次检查）                             |
| 7    | 10.29 | 软件架构设计                                  | 15   | 12.24 |  <span style="color:red;">**项目展示汇报**               |
