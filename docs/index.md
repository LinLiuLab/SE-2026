!!! danger "版权声明"
    ...
    本项目为 2026-2027 年秋季学期清华大学软件学院开设的《软件工程》课程的文档。
...
| ------------------ | --------------------------------------------------------------- |
| **课程号**         | 44100203                                                        |
| **学期**           | 2026—2027 学年度秋季学期                                        |
| **主讲教师**       | **[刘璘](https://www.thss.tsinghua.edu.cn/faculty/liulin.htm)** |
| **助教团队** | 赵子钰、张雨恬、许德成、童新荷、 李梓晟、刘怿轩、张馨月、袁箐鸿、王德宇             |
...
| 周次 | 日期  | 内容                                                  | 周次 | 日期  | 内容                                                   |
| ---- | ----- | ----------------------------------------------------- | ---- | ----- | ------------------------------------------------------ |
| 1    | 9.17  | 软件工程概述                                          | 9    | 11.12 | 软件系统建模                          |
| 2    | 9.24  | 单元测试 & Docker部署                                 | 10   | 11.19 | 行为驱动的开发（第一次检查）                                          |
| 3    | 10.1  | <span style="color:red;">**国庆放假**</span>              | 11   | 11.26 | 数据建模                              |
| 4    | 10.8  | 软件开发管理                                        | 12   | 12.3  | 失效模式处理 （第二次检查）                                |
| 5    | 10.15 | 需求获取                                        | 13   | 12.10 | 产品测试                                    |
| 6    | 10.22 | 软件架构设计与agent编排                                      | 14   | 12.17 | 系统部署与发布（第三次检查）                             |
| 7    | 10.29 | 设计模式                                  | 15   | 12.24 |  <span style="color:red;">**项目展示汇报**               |
| 8    | 11.5  | <span style="color:blue;">**项目中期进展汇报**</span> | 16   | 12.31 | <span style="color:red;">**产品交付**  |

## 作业与评分
课程成绩由四部分组成：课程参与（5 分）、课堂小测（5 分）、个人作业（30 分）和团队项目（60 分），基础分合计 100 分，奖励分另列。
...
!!! note "课堂小测"
    ...
    **课堂小测**覆盖授课内容知识点，通过雨课堂发题，独立计入课程成绩，占 5 分。
